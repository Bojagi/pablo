...
Pablo is the design system of Bojagi built on top of `styled-components` and `styled-system`. 
...
<Box display="flex" mx={-4}>
  <Button mx={4}>Accept</Button>
  <Button mx={4} variant="secondary">Cancel</Button>
</Box>
```
