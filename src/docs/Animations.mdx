...
(e.g. to make it work with `styled-components`).
...
You can use custom props for animations by just accessing it like usual in styled-components (like with the duration
